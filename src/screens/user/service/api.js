...
export const getAllStationsByLocationAPI = (data) =>
    apiGetRequest({
    apiUrl: `${API_URL}/charging-stations/get-all-stations-by-location?owner_id=${data.userId}&latitude=${data.coords.latitude}&longitude=${data.coords.longitude}&radius=${data.radius}`,
